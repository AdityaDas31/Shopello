...
const { createProduct, getAllProducts, updateProduct, deleteProduct, getProductDetails, productApproval, productAvailable, getAdminProduct } = require('../controllers/productController');
