...
const { createProduct, getAllProducts, updateProduct, deleteProduct, getProductDetails, productApproval, productAvailable, getAdminProduct, getProducts, createProductReview, getProductReviews, deleteReview } = require('../controllers/productController');
